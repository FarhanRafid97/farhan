        ...
        <div className="flex-1  h-full">
          ...
          <div className="flex-2 w-full md:w-1/2 mt-8 py-4 padding-left-layout ">
            ...
            <p className="text-ascent text-sm lg:text-base text-justify">
              Proficient in Golang and Node.js, I specialize in developing microservices with a
              focus on efficient communication through gRPC. My expertise extends to SQL and Redis,
              enabling me to design and optimize databases for high-performance applications.
            </p>
          </div>
        </div>
